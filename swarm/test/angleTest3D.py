...
locations = np.array([[0.,0.,0.],[0.,1.,0.],[1.,1.,1.]])
curDirections = np.array([[1.,1.,1.],[1.,0.,0.],[0.,0.,-1.]])
N = 3
dimension = 3
...
print(directionsOtherFish.shape)
...
# normalize direction
normalRelPosOtherFish = directionsOtherFish / distances[:,:,np.newaxis]
print("normalRelPosOtherFish")
print(normalRelPosOtherFish)
print(1./np.sqrt(3.))
...
# print(angles*180/np.pi)
# https://stackoverflow.com/questions/5188561/signed-angle-between-two-3d-vectors-with-same-origin-within-the-same-plane/5190354#5190354