...
do
    python evaluateReward.py --resdir ${DIR} --tfile ${trajectory}  \
        --N ${N} --NN ${NN} --D ${D} --tidx 0 --nfish 25 --rnn ${RNN}
     
    python evaluateReward.py --resdir ${DIR} --tfile ${trajectory}  \
        --N ${N} --NN ${NN} --D ${D} --tidx 250 --nfish 25 --rnn ${RNN}
   
    python evaluateReward.py --resdir ${DIR} --tfile ${trajectory}  \
        --N ${N} --NN ${NN} --D ${D} --tidx 500 --nfish 25 --rnn ${RNN}
    
    python evaluateReward.py --resdir ${DIR} --tfile ${trajectory}  \
        --N ${N} --NN ${NN} --D ${D} --tidx 750 --nfish 25 --rnn ${RNN}

    python evaluateReward.py --resdir ${DIR} --tfile ${trajectory}  \
        --N ${N} --NN ${NN} --D ${D} --tidx 999 --nfish 25 --rnn ${RNN}
done
